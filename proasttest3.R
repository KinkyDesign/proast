...
function(dataset,predictionFeature,parameters){
    ...
    #than the threshold value, a stop message is returned.).
      changeV<- read.table('/Users/pantelispanka/Jaqpot/proast/change_variables.txt',col.names='change_variables',colClasses='character')
      load('/Users/pantelispanka/Jaqpot/proast/trial1.RData')
